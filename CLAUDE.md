...
- `draftBoard.json` / `draftGrades.json` — **generated** from the recap pipeline after each draft (Draft Central board; homepage Post-Draft Power Rankings). Regenerate via the recipe in the recap skill's HANDOFF; newest season first in `seasons[]`
