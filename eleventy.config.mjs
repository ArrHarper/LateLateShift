...
export default function (eleventyConfig) {
    ...
    // Prebuilt season-review pages (generated by season-review-mockups/generate.js,
    // copied here as index.html) publish at /draft/<yr>-review/.
    for (const yr of readdirSync("src/season-reviews")) {
